package com.whoiszxl.house.common.autoconfig;
...
/**
* @author whoiszxl:
* @version 创建时间：2018年2月17日 下午10:18:50
* @description 
*/
@Configuration
@ConditionalOnClass({HttpClient.class})//在httpClient存在的情况下才会加载如下的config
@EnableConfigurationProperties(HttpClientProperties.class)//将自己的配置类加载进来
